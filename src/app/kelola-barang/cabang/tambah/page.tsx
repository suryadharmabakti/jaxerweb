      ...
      <div className="mt-4 w-full max-w-3xl rounded-2xl bg-white border border-gray-200 p-5 shadow-sm">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
          <label className="grid gap-1">
            <span className="text-xs text-gray-600">Nama Cabang</span>
            <input
              value={draft.name}
          ...
          <label className="grid gap-1">
            <span className="text-xs text-gray-600">No Telpon Admin</span>
            <input
              value={draft.phone}
          ...
          <label className="grid gap-1 sm:col-span-2">
            <span className="text-xs text-gray-600">Lokasi Cabang</span>
            <input
